...
from nltk_utils.nltk_utils import bag_of_words, tokenize, stem
...
# Combine chatbot intents and medical data
for intent in intents['intents']:
    if intent['tag'] == 'medical':
        intent['patterns'].extend(medical_data['symptoms'])
...
# Save the model and additional data
data = {
    ...
    "all_words": all_words,
    "tags": tags,
    "medical_data": medical_data  # Include medical data
}
